...
TinyUSBSimplePacketComs::TinyUSBSimplePacketComs() {


}
void TinyUSBSimplePacketComs::initializeUSB(){
...
*/
 bool TinyUSBSimplePacketComs::isPacketAvailible(){
	 if(!initFlag){
		 initFlag=true;
...
*/
 int32_t TinyUSBSimplePacketComs::getPacket(uint8_t * buffer,uint32_t numberOfBytes){
...
* this data should already be framed, checksummed and validated as a valid packet
*/
 int32_t TinyUSBSimplePacketComs::sendPacket(uint8_t * buffer,uint32_t numberOfBytes){
	 if(!initFlag){
		 return 0;
	 }
